...
void InitializeArray(Diligent::IDeviceContext& context, Diligent::IRenderDevice& device, Diligent::IShaderResourceVariable* variable, uint32_t arraySize, bool transition = true, Diligent::TEXTURE_FORMAT override = Diligent::TEX_FORMAT_UNKNOWN);
