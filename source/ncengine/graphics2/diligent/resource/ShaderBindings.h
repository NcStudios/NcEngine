    ...
    public:
        explicit ShaderBindings(Diligent::IRenderDevice& device,
            ...
            : m_perFrameSignature{
                ...
                StructuredBufferDesc{"ShapeKeyAnimationMetadata", Diligent::SHADER_TYPE_VERTEX, memorySettings.maxShapeKeyAnimations},
                ...
                TextureBufferDesc{"ShapeKeyClips",                Diligent::SHADER_TYPE_VERTEX, memorySettings.maxShapeKeyAnimations},
