...
class PerPassResourceSignature
{
    public:
        ...
        auto GetColorSinksResource()             -> SinkBufferResource&                   { return *m_offscreenColorResource; }
        auto GetDepthSinksResource()             -> SinkBufferResource&                   { return *m_offscreenDepthResource; }
