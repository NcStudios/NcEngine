                                         ...
                                         std::string_view entryPoint) -> Diligent::RefCntAutoPtr<Diligent::IShader>
{
    ...
    createInfo.CompileFlags = m_isRowMajor ? Diligent::SHADER_COMPILE_FLAG_ENABLE_UNBOUNDED_ARRAYS : Diligent::SHADER_COMPILE_FLAG_PACK_MATRIX_ROW_MAJOR | Diligent::SHADER_COMPILE_FLAG_ENABLE_UNBOUNDED_ARRAYS;
