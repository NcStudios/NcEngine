...
bool MeshAssetManager::Load(const std::string& path, bool isExternal, asset_flags_type flags)
{
    if (IsLoaded(path))
    {
        return false;
...
bool MeshAssetManager::Load(std::span<const std::string> paths, bool isExternal, asset_flags_type flags)
{
...
bool MeshAssetManager::Unload(const std::string& path, asset_flags_type flags)
{
...
void MeshAssetManager::UnloadAll(asset_flags_type flags)
{
...
auto MeshAssetManager::Acquire(const std::string& path, asset_flags_type flags) const -> MeshView
{
...
bool MeshAssetManager::IsLoaded(const std::string& path, asset_flags_type flags) const
{
