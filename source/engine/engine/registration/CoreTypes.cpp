...
void RegisterCoreTypes(ecs::ComponentRegistry& registry, size_t maxEntities)
{
    ...
    Register<Tag>(registry, maxEntities, TagId, "Tag", ui::editor::TagUIWidget);
    Register<Transform>(registry, maxEntities, TransformId, "Transform", ui::editor::TransformUIWidget);
