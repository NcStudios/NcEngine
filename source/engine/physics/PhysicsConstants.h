...
constexpr float PenetrationSlop = 0.001f;              // How far objects are allowed to penetrate
...
constexpr float BaumgarteFactor = 0.275f;               // Bias factor for baumgarte stabilization [0, 1]
constexpr float PositionCorrectionFactor = 0.1f;    // Percentage of mtv to use for direct position correction
