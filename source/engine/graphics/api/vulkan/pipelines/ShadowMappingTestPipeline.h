...
class ShadowMappingTestPipeline : public IPipeline
{
public:
    ShadowMappingTestPipeline(const Device& device, ShaderBindingManager* shaderBindingManager, vk::RenderPass renderPass);
    ~ShadowMappingTestPipeline() noexcept;
