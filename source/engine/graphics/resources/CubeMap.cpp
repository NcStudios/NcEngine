...
{
    CubeMap::CubeMap(Base* base, GpuAllocator* allocator, const std::array<unique_stbi, 6>& pixels, uint32_t width, uint32_t height, uint32_t cubeMapSize, const std::string& uid)
        : m_base{base},
    ...
    void CubeMap::Bind(const std::array<unique_stbi, 6>& pixels, uint32_t width, uint32_t height, uint32_t cubeMapSize)
    {
