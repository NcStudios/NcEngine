...
As an alternative: configure, build and install steps can be batched via build script through the included tools/tasks.vs.json file. The build script is accessed via the context menu for the engine, sample, editor or test directories.
...
This creates the context menus that are wired up to invoke the build script.
