...
namespace DirectX
{
    namespace Internal
    {
        ...
        protected:
            ...
            void __cdecl Draw(D3D11_PRIMITIVE_TOPOLOGY topology, bool isIndexed, uint16_t const* indices, size_t indexCount, size_t vertexCount, _Out_ void** pMappedVertices);
