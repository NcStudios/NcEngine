...
#include "pch.h"
#include "external/directx/tk/PrimitiveBatch.h"
...
public:
    ...
    void Draw(D3D11_PRIMITIVE_TOPOLOGY topology, bool isIndexed, uint16_t const* indices, size_t indexCount, size_t vertexCount, _Out_ void** pMappedVertices);
