...
constexpr float MercuryTilt = nc::DegreesToRadians(0.03f);
constexpr float VenusTilt = nc::DegreesToRadians(2.64f);
constexpr float EarthTilt = nc::DegreesToRadians(23.44f);
constexpr float MarsTilt = nc::DegreesToRadians(25.19f);
constexpr float JupiterTilt = nc::DegreesToRadians(3.13f);
constexpr float SaturnTilt = nc::DegreesToRadians(26.73f);
constexpr float UranusTilt = nc::DegreesToRadians(82.23f);
constexpr float NeptuneTilt = nc::DegreesToRadians(28.32f);
constexpr float PlutoTilt = nc::DegreesToRadians(57.47f);
