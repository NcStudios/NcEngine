...
{
    PointLight::PointLight(Graphics& graphics, DirectX::XMFLOAT3 pos, float radius)
        : m_cBuf(graphics)
    {
    ...
    {
        utils::editor::EditorManager::PointLightControl(&m_constBufData.pos.x,            &m_constBufData.pos.y,          &m_constBufData.pos.z,
