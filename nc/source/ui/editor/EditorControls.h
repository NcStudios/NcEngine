...
namespace nc::ui::editor::controls
{
    ...
    inline void StateAttachmentElement(StateAttachment* comp);
    ...
    void EntityPanel(Registry* registry, Entity entity)
    {
        ...
        for(const auto& comp : registry->Get<AttachmentGroup>(entity)->GetAttachments())
            controls::StateAttachmentElement(comp);
