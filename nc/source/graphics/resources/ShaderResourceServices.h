    ...
    class ShaderResourceServices
    {
        public:
            ShaderResourceServices(Graphics* graphics, const config::MemorySettings& memorySettings, Vector2 dimensions)
                : m_shader_descriptor_sets{graphics},
                  m_objectDataManager{0, graphics, &m_shader_descriptor_sets, memorySettings.maxRenderers},
                  m_pointLightManager{1, graphics, &m_shader_descriptor_sets, memorySettings.maxPointLights},
                  ...
                  m_environmentDataManager{5, graphics, &m_shader_descriptor_sets}
            {
