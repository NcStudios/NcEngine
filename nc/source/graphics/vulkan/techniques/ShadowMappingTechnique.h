...
namespace nc::graphics
{
    ...
    namespace vulkan
    {
        ...
        {
            public:
                ShadowMappingTechnique(nc::graphics::Graphics2* graphics, vk::RenderPass* renderPass);
                ~ShadowMappingTechnique();

                void Bind(vk::CommandBuffer* cmd);
                void Record(vk::CommandBuffer* cmd, registry_type* registry, std::span<nc::vulkan::PointLight> pointLights, std::span<nc::vulkan::MeshRenderer> meshRenderers);
