...
{
    class Device; class RenderPass; class FrameBuffers; class GraphicsPipeline; class VertexBuffer;
    ...
    class Commands
    {
        public:
            ...
            void RecordRenderCommand(const vulkan::Device& device, const vulkan::RenderPass& renderPass, const FrameBuffers& frameBuffers, const vulkan::GraphicsPipeline& pipeline, const vulkan::VertexBuffer& vertexBuffer);
