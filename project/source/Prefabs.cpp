...
template<> EntityHandle Create<Boar>(Vector3 position, Vector3 rotation, Vector3 scale, std::string tag)
{
    ...
    NcAddEngineComponent<Renderer>(handle, mesh::Boar, material::Boar);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Cattle, material::Cattle);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Coal, material::Coal);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Disc, material::CoinOne);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Disc, material::CoinTwo);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Disc, material::CoinTen);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Dog, material::Dog);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Donkey, material::Donkey);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Disc, material::Dwarf);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Grain, material::Grain);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Ruby, material::Ruby);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Sheep, material::Sheep);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Stable, material::Stable);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::StartingPlayerPiece, material::StartingPlayerPiece);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Stone, material::Stone);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Vegetable, material::Vegetable);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::Wood, material::Wood);
    auto transform = NcGetTransform(NcGetEntity(handle)->Handles.transform);
    NcAddUserComponent<project::GamePiece>(handle, transform);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileAdditionalDwelling);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileCoupleDwelling);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileDwelling);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileBeerParlor);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileBlacksmithingParlor);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileBlacksmith);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileBreakfastRoom);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileBreedingCave);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileBroomChamber);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileBuilder);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileCarpenter);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileCookingCave);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileCuddleRoom);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileDogSchool);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileFodderChamber);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileFoodChamber);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileGuestRoom);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileHuntingParlor);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileMainStorage);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileMilkingParlor);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileMiner);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileMiningCave);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileMixedDwelling);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileOfficeRoom);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileOreStorage);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTilePeacefulCave);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTilePrayerChamber);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileQuarry);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileRubySupplier);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileSeam);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileSimpleDwelling);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileSimpleDwelling2);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileSlaughterCave);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileSparePartStorage);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileStateParlor);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileStoneCarver);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileStoneStorage);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileStoneSupplier);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileStubbleRoom);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileSupplierStorage);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileTrader);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileTreasureChamber);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileWeaponStorage);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileWeavingParlor);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileWoodSupplier);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileWorkingCave);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileWorkRoom);
    return handle;
}
...
{
    auto handle = NcCreateEntity(position, rotation, scale, tag);
    NcAddEngineComponent<Renderer>(handle, mesh::FurnishingTile, material::FurnishingTileWritingChamber);
    return handle;
}
