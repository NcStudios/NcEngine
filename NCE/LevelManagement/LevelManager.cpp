...
{
    LevelManager::LevelManager(createEntityFunc t_createEntityFunc)
    {
        _createEntity = t_createEntityFunc;
    }

    void LevelManager::CreateTestLevel()
    {
        Common::EntityWeakPtr character1 = _createEntity();
        ...
        Common::EntityWeakPtr spawner = _createEntity();
