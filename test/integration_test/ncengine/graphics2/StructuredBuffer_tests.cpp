    ...
    protected:
        ...
        StructuredBufferTest()
        {
            signature = std::make_unique<nc::graphics::PerFrameResourceSignature>(
                ...
                signatureName,
                bindingIndex,
                nc::graphics::StructuredBufferResourceDesc{"TransformBufferData",        Diligent::SHADER_TYPE::SHADER_TYPE_VERTEX, 1, 1},
                nc::graphics::StructuredBufferResourceDesc{"InstanceBufferData",         Diligent::SHADER_TYPE::SHADER_TYPE_VERTEX, 1, 1},
