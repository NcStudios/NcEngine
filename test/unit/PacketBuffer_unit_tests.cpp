...
{
    PacketBuffer buffer;
    buffer.size = WriteBuffer(buffer.data, 0u, vBool);
...
{
    PacketBuffer buffer;
    buffer.size = WriteBuffer(buffer.data, 0u, vUint8);
...
{
    PacketBuffer buffer;
    buffer.size = WriteBuffer(buffer.data, 0u, vUint32);
...
{
    PacketBuffer buffer;
    buffer.size = WriteBuffer(buffer.data, 0u, vFloat);
...
{
    PacketBuffer buffer;
    buffer.size = WriteBuffer(buffer.data, 0u, vCharArray);
...
{
    PacketBuffer buffer;
    buffer.size = WriteBuffer(buffer.data, 0u, vFloat, vUint32, vCharArray, vUint8, vBool);
